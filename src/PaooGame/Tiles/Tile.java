...
//    public static Tile soilTile         = new SoilTile(4);      /*!< Dala de tip sol/pamant*/
    ...
    public static Tile blankTile        = new BlankTile(10);
    public static Tile groundTile       = new GroundTile(0);
    public static Tile crackedGroundTile= new CrackedGroundTile(1);
    public static Tile leftWallTile     = new LeftWallTile(2);
    public static Tile rightWallTile    = new RightWallTile(3);
    public static Tile wall             = new WallTile(4);
    public static Tile heartFull        = new HeartFullTile(5);
    public static Tile chestOpen        = new ChestOpenTile(6);
    public static Tile bottomWall       = new BottomWallTile(7);
    public static Tile downWall         = new DownWallTile(8);
